...
Reading now, I feel like the Results could be edited to make the supporting cast (most of the other figures) feel more like supporting cast. For example, I like the idea of combining \fref{Ont_testing} and \fref{Ont_calibration_testify} (although it seems like we could do that just with panels?). \ben{combination is done.}
...
The same model structure can be run as an ordinary differential equation, a discrete-time deterministic model, or a discrete-time stochastic model with dynamical noise.
...
\ben{why do we even need ``dynamical noise'' here? How about just ``discrete-time stochastic model''? (``dynamical noise'' was added by JD in \href{https://github.com/mac-theobio/macpan_base/commit/f613549f1b93275da537825a60551a14f32f0536}{this commit})}
