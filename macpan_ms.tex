...
\mike{I will double check, it looks smooth because of the 7 day MA.}
}
...
Figure \ref{fig:Ont_calibration} shows the fit to data of a basic model includes mobility with two additional breaks and phenomenological heterogeneity and calibrates to COVID new cases and deaths for Ontario from 24 February 2020 (the first covid case reported in Ontario) to 30 August 2020. \david{what is ``a basic model''?} \mike{adding more details in text.}
...
\jd{Yes. First wave wasn't until winter 2020. The second wave was a relaxation wave of some kind.}
...
because reported cases and death time series are most commonly applicable to public data \david{applicable to public data???  Is this supposed to mean that cases and deaths are what we can typically obtain publicly?} \mike{Yes.}
